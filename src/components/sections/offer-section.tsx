  ...
  return (
    <section id="oferta" className="py-20 md:py-28 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <Card className="max-w-4xl mx-auto bg-primary/20 shadow-2xl border-accent/30 shadow-accent/20 transition-all hover:shadow-accent/30 neon-glow-accent">
          <CardContent className="p-6 md:p-12 text-center">
            ...
            <div className="my-8 flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8">
                <div className="text-center">
                    ...
                    <p className="font-semibold text-foreground/80">(ou 4x de R$ 10,18)</p>
                </div>
            ...
            <div className="my-8">
              <p className="font-semibold text-foreground">Esta oferta com desconto termina em:</p>
              <Countdown />
            </div>
