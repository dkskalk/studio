...
export default function HeroSection() {
  return (
    <section id="inicio" className="bg-gradient-to-b from-primary/50 to-background py-20 md:py-28 text-center">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-10 max-w-3xl mx-auto">
            <div className="aspect-video w-full rounded-lg overflow-hidden shadow-2xl border-4 border-background bg-muted flex items-center justify-center">
              {/* Vídeo aqui */}
