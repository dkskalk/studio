...
const modules = [
  ...
  },
  {
   ...
   {
    icon: <Gift className="h-8 w-8 text-primary-foreground" />,
    ...
    <section className="py-20 md:py-28 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto">
            <Badge variant="secondary">Conteúdo do método</Badge>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {modules.map((module) => (
            <Card key={module.title} className="flex flex-col text-center border-2 border-primary shadow-sm bg-primary/50">
